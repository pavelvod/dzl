...
from .base import BaseFoldMultiClassClassifier
import sklearn.preprocessing as prep


# class CatboostClassifierFoldTrainer(BaseFoldMultiClassClassifier):
#
...
class LightGBMMultiClassClassifierFoldTrainer(BaseFoldMultiClassClassifier):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

    def get_model(self):
        self.params['init_params']['num_class'] = self.ds.y.iloc[:, 0].nunique()
        self.params['init_params']['objective'] = 'multiclass'
        self.params['init_params']['metric'] = 'auc_mu'
...
#
# class XGBoostClassifierFoldTrainer(BaseFoldMultiClassClassifier):
#
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
#
...
#
#
# class TabNetFoldTrainer(BaseFoldMultiClassClassifier):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
#         self.cat_idxs = []
#         self.cat_dims = []
...
#
#
# class SklearnClassifierFoldTrainer(BaseFoldMultiClassClassifier):
#
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
#
